...
function Home() {
  ...
  const handleCategoryClick = (category) => {
    navigate(`/gigs?category=${category}`);
  };

  return (
    <div className="home">

<Featured search={search} setSearch={setSearch} onSubmit={handleSubmit} />
      <TrustedBy />
      ...
      <div className="explore">
        <div className="container">
          ...
          <div className="items">
            ...
            <div className="item" onClick={() => handleCategoryClick("Photography")}>
              <img
      ...
      <div className="features dark">
        <div className="container">
          <div className="item">
            ...
            <Link to="#">
              <button>Explore SkillBridge Business</button>
            </Link>
          </div>
          <div className="item">
            <img
